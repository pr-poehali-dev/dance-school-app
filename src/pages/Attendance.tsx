...
const studentsByGroup: Record<string, string[]> = {
  "Мурашки 1": ["Анна Петрова", "Светлана Иванова", "Ксения Романова", "Дарья Трофимова", "Полина Шувалова", "Юлия Морозова", "Татьяна Орлова", "Марина Зотова", "Алина Крылова", "Вика Нечаева", "Соня Громова", "Настя Федотова"],
  "Мурашки 2": ["Лиза Борисова", "Маша Зайцева", "Катя Орлова", "Таня Кузнецова", "Поля Смирнова", "Даша Белова", "Оля Новикова", "Аня Морозова", "Вика Соколова", "Наташа Иванова", "Лена Волкова", "Рита Фролова", "Ира Козлова", "Юля Лебедева"],
  "Средняя группа": ["Мария Смирнова", "Екатерина Соколова", "Ирина Волкова", "Наталья Лебедева", "Людмила Новикова", "Галина Федотова", "Валерия Щербакова", "Оксана Громова", "Диана Орлова", "Карина Белова", "Алёна Тихонова", "Вероника Зотова", "Злата Павлова", "Кристина Фёдорова", "Таисия Морозова", "Арина Кириллова"],
  "Старшая группа": ["Дмитрий Козлов", "Артём Белов", "Никита Сидоров", "Илья Фролов", "Сергей Попов", "Максим Кириллов", "Роман Егоров", "Андрей Тихонов", "Кирилл Орлов", "Иван Зайцев", "Александр Лебедев", "Павел Новиков", "Николай Борисов", "Степан Фёдоров", "Тимур Соколов", "Денис Волков", "Глеб Смирнов", "Антон Кузнецов"],
};
